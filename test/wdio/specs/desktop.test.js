...
const screenStaticElemenentFooter = getBrowserSpecificFile(
  path.join(screenshotDir, 'desktop-static-element-footer.png')
);
...
const screenResponsiveDocument480 = getBrowserSpecificFile(
  path.join(screenshotDir, 'desktop-responsive-document-480.png')
);
const screenResponsiveDocument1600 = getBrowserSpecificFile(
  path.join(screenshotDir, 'desktop-responsive-document-1600.png')
);
const screenResponsiveElemenentFooter480 = getBrowserSpecificFile(
  path.join(screenshotDir, 'desktop-responsive-element-footer-480.png')
);
const screenResponsiveElemenentFooter1600 = getBrowserSpecificFile(
  path.join(screenshotDir, 'desktop-responsive-element-footer-1600.png')
);
const screenResponsiveViewport480 = getBrowserSpecificFile(
  path.join(screenshotDir, 'desktop-responsive-viewport-480.png')
);
const screenResponsiveViewport1600 = getBrowserSpecificFile(
  path.join(screenshotDir, 'desktop-responsive-viewport-1600.png')
);

const screenResponsiveMinWidthDocument480 = getBrowserSpecificFile(
  path.join(screenshotDir, 'desktop-responsive-min-width-document-480.png')
);
const screenResponsiveMinWidthDocument1600 = getBrowserSpecificFile(
  path.join(screenshotDir, 'desktop-responsive-min-width-document-1600.png')
);
const screenResponsiveMinWidthElemenentFooter = getBrowserSpecificFile(
  path.join(screenshotDir, 'desktop-responsive-min-width-element-footer.png')
);
const screenResponsiveMinWidthViewport480 = getBrowserSpecificFile(
  path.join(screenshotDir, 'desktop-responsive-min-width-viewport-480.png')
);
const screenResponsiveMinWidthViewport1600 = getBrowserSpecificFile(
  path.join(screenshotDir, 'desktop-responsive-min-width-viewport-1600.png')
);

const screenDynamicSizeDocument480 = getBrowserSpecificFile(
  path.join(screenshotDir, 'desktop-dynamic-size-document-480.png')
);
const screenDynamicSizeViewport480 = getBrowserSpecificFile(
  path.join(screenshotDir, 'desktop-dynamic-size-viewport-480.png')
);
const screenDynamicSizeElement480 = getBrowserSpecificFile(
  path.join(screenshotDir, 'desktop-dynamic-size-element-480.png')
);
...
const screenFullpageModalDocument480 = getBrowserSpecificFile(
  path.join(screenshotDir, 'desktop-fullpage-modal-document-480.png')
);
const screenFullpageModalViewport480 = getBrowserSpecificFile(
  path.join(screenshotDir, 'desktop-fullpage-modal-viewport-480.png')
);

const screenElementModifierHideDocument480 = getBrowserSpecificFile(
  path.join(screenshotDir, 'desktop-element-modifier-hide-document-480.png')
);
const screenElementModifierHideViewport480 = getBrowserSpecificFile(
  path.join(screenshotDir, 'desktop-element-modifier-hide-viewport-480.png')
);
const screenElementModifierHideElement480 = getBrowserSpecificFile(
  path.join(screenshotDir, 'desktop-element-modifier-hide-element-480.png')
);

const screenElementModifierRemoveDocument480 = getBrowserSpecificFile(
  path.join(screenshotDir, 'desktop-element-modifier-remove-document-480.png')
);
const screenElementModifierRemoveViewport480 = getBrowserSpecificFile(
  path.join(screenshotDir, 'desktop-element-modifier-remove-viewport-480.png')
);
const screenElementModifierRemoveElement480 = getBrowserSpecificFile(
  path.join(screenshotDir, 'desktop-element-modifier-remove-element-480.png')
);
    ...
    context('saveElementScreenshot', function() {
      it('with window size 480px', async function() {
        const screenPath = path.join(
          tmpDir,
          '/desktop-responsive-min-width-element-footer-480',
          `${generateUUID()}.png`
        );
      ...
      it('with window size 1600px', async function() {
        const screenPath = path.join(
          tmpDir,
          '/desktop-responsive-min-width-element-footer-1600',
          `${generateUUID()}.png`
        );
